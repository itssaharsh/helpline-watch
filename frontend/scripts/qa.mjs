...
await page.waitForSelector('text=/Done: \\d+ fake/', { timeout: 30000 })
await page.waitForTimeout(800)
await page.screenshot({ path: 'qa/demo-done-1440.png', fullPage: true })
const fakeChip = page.locator('button.mark-fake').first()
...
// 3. a second city tab + the setup panel
await page.getByRole('tab', { name: /Kolkata/ }).click()
await page.waitForTimeout(500)
await page.screenshot({ path: 'qa/kolkata-1440.png', fullPage: false })
await page.getByRole('button', { name: 'Change brand or cities' }).click()
await page.waitForTimeout(400)
await page.screenshot({ path: 'qa/setup-1440.png', fullPage: false })
...
await page.waitForSelector('text=/Done: \\d+ fake/', { timeout: 30000 })
await page.locator('button.mark-fake').first().focus(); await page.keyboard.press('Enter')
