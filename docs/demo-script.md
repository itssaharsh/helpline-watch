...
|---|---|---|
| 0:00–0:10 | Title card over the populated console: globe, lime slab, findings | "1.73 lakh complaints and over ₹2,100 crore lost in India to fake customer-care numbers found on Google. Scammers plant them where victims search. This is the page a victim in Mumbai sees, marked up." |
| 0:10–0:35 | Click **Sweep again**. The progress line runs, the globe markers pulse Mumbai to Kolkata, findings appear on the left, the slab counts up to 3, and `+91 74110 29385` flashes with a FAKE mark in the Places box | "One brand, five cities, every surface: search results, the answer box, People also ask, the local pack, Maps, ads. Every number a victim would be shown, compared with the bank's official list, marked in place." |
...
| 1:50–2:15 | Click **Download takedown pack (3)** on the lime slab; open `report.md` and `complaint_template.txt` | "The output is a takedown pack: CSV, evidence JSON, a report with a replayable SerpApi archive link per sighting and the right Google form per surface, and a cybercrime.gov.in complaint template." |
